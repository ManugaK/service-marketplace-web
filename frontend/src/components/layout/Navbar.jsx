      ...
      <nav className="mx-auto flex h-16 w-full max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8 2xl:max-w-550 min-[1920px]:max-w-700 min-[2560px]:max-w-800 2xl:h-18 2xl:px-12 min-[1920px]:h-20 min-[1920px]:px-16 min-[2560px]:px-20">
          ...
          {navLinks.map((link, index) => (
            <a
              ...
              className={`relative cursor-pointer text-sm font-medium transition hover:text-[#05735f] 2xl:text-[15px] min-[1920px]:text-base ${
                index === 0 ? 'text-[#05735f]' : 'text-slate-600'
              }`}
            >
              {link.label}
        ...
        <div className="hidden items-center gap-5 lg:flex 2xl:gap-6 min-[1920px]:gap-8 min-[2560px]:gap-10">
          <button
            ...
            className="cursor-pointer text-sm font-semibold text-slate-700 transition hover:text-[#05735f] 2xl:text-[15px] min-[1920px]:text-base"
          >
            Sign In
          </button>
          ...
          <button
            ...
            className="cursor-pointer rounded-lg bg-[#05735f] px-6 py-2.5 text-sm font-bold text-white transition hover:bg-[#046553] 2xl:px-7 2xl:py-3 2xl:text-[15px] min-[1920px]:px-8 min-[1920px]:py-3.5 min-[1920px]:text-base"
          >
            Sign Up
          </button>
        </div>
        ...
        <button
          ...
          className="inline-flex h-10 w-10 cursor-pointer items-center justify-center rounded-lg border border-slate-200 text-slate-700 lg:hidden 2xl:h-11 2xl:w-11 min-[1920px]:h-12 min-[1920px]:w-12"
          ...
          <div className="mx-auto flex max-w-7xl flex-col gap-2 2xl:max-w-400 min-[1920px]:max-w-440">
            {navLinks.map((link) => (
              <a
                ...
                href={link.href}
                onClick={closeMenu}
                className="cursor-pointer rounded-lg px-3 py-3 text-sm font-medium text-slate-700 transition hover:bg-emerald-50 hover:text-[#05735f] 2xl:px-4 2xl:py-3.5 2xl:text-[15px] min-[1920px]:text-base"
              >
                {link.label}
              </a>
            ))}
            ...
            <div className="mt-3 grid grid-cols-2 gap-3 border-t border-slate-100 pt-4 2xl:gap-4 2xl:pt-5">
              <button
                type="button"
                onClick={handleSigninClick}
                className="cursor-pointer rounded-lg border border-slate-200 px-4 py-3 text-center text-sm font-bold text-slate-700 transition hover:bg-slate-50 2xl:px-5 2xl:py-3.5 2xl:text-[15px] min-[1920px]:text-base"
              >
                Sign In
              </button>
              ...
              <button
                type="button"
                onClick={handleSignupClick}
                className="cursor-pointer rounded-lg bg-[#05735f] px-4 py-3 text-center text-sm font-bold text-white transition hover:bg-[#046553] 2xl:px-5 2xl:py-3.5 2xl:text-[15px] min-[1920px]:text-base"
              >
                Sign Up
              </button>
            </div>
